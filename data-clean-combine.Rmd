...
wd_c_date = weather_data_c[weather_data_c$date %in% sd, c(1:14)]
...
write_csv(f_sam, "data/trn_s.csv")
write_csv(trn_data, "data/trn_c.csv")
write_csv(tst_data, "data/tst_c.csv")
```
